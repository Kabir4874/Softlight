        ...
        <div className=" border-y pt-[1.25rem] pb-12 border-alto2 mt-[2.88rem] bg-white flex items-start">
          ...
          <div>
            ...
            <div className="mb-[1.94rem] flex items-center gap-[0.44rem]">
              ...
              />
              <button className="py-4 px-[1.25rem] rounded-[2.5rem] bg-jaguar text-white font-nunito text-[0.875rem] font-bold border border-jaguar hover:bg-white hover:text-jaguar transition-all duration-300">
                Submit
              </button>
            </div>
