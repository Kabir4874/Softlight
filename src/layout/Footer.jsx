    ...
    <div className=" w-full footer-bg mt-[4.33rem] pt-[8.84rem]">
      <div className="w-[75rem] mx-auto ">
        <div>
          ...
          <Link to={"/contact"}>
          <button className=" capitalize py-[0.625rem] px-3 flex items-center justify-center gap-[0.625rem] rounded-[2.5rem] bg-tarawera text-white font-nunito text-[0.875rem] font-bold group hover:bg-white hover:text-tarawera transition-all duration-300 border border-tarawera">
            say hello{" "}
            <svg
              width="32"
              height="32"
            ...
            >
              <path
                ...
                fill="white"
                className="transition-all duration-300 fill-current text-white group-hover:text-tarawera"
              />
              <path
                ...
                fill="#08364A"
                className="transition-all duration-300 fill-current text-tarawera group-hover:text-white"
              />
            </svg>
          </button>
        </Link>
